...
You may be asking, what if I have `GenomicRanges` object? Almost always, you can easily transform `GenomicRanges` into a `data.frame` using a helper function such as `as.data.frame()`.
